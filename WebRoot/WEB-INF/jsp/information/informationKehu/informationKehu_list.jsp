...
<div id="page-content" class="clearfix">
  <div class="row-fluid">
	<div class="row-fluid">
			<!-- 检索开始  -->
			<form action="informationKehuChangtu/informationKehulistPage.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">拼车费用</th>
						<th class="center">里程数</th>
						<th class="center">可乘人数</th>
				...
				<!-- 开始循环 -->	
				<c:choose>
					<c:when test="${not empty informationKehulist}">
						<c:if test="${QX.cha == 1 }">
							<c:forEach items="${informationKehulist}" var="var" varStatus="vs">
								<tr>
									<td class='center' style="width: 30px;">
										<label><input type='checkbox' name='ids' value="${var.information_kehu_changtu_id}" /><span class="lbl"></span></label>
									</td>
									<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class="center">${var.userName}</td>
											<td class="center">${var.phone}</td>
											<td class="center">${var.departureTime}</td>
											<td class="center">${var.departureCity}</td>
											<td class="center">${var.departurePlace}</td>
											<td class="center">${var.arrivalCity}</td>
											<td class="center">${var.destination}</td>
											<td class="center">${var.carpoolFee}</td>
											<td class="center">${var.mileage}</td>
											<td class="center">${var.userNum}</td>
											<td class="center">${var.releaseTime}</td>
										<%-- 	<td style="width: 68px;">
