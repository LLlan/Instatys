   ...
   <!-- 商铺详情-->
    <div class="weui-tab" >
        <div class="weui-navbar" style="background-color: #fff;position:fixed;left:0;top:60px;z-index:999;">
            <a class="weui-navbar__item weui-bar__item--on boxShadow1" href="api/h5KeHu/shops.do" style="padding:10px 0">
                销售量
            </a>
            <a class="weui-navbar__item boxShadow1" href="api/h5KeHu/shopsTwo.do" style="padding:10px 0">
                距离最近
            </a>
	                ...
	                <a href="api/h5KeHu/shop.do?user_shangjia_id=${pd.user_shangjia_id }" class="weui-media-boxt weui-media-box_appmsg1 delicious">
	                    ...
	                    <div class="weui-media-box__bd">
	                        ...
	                        <div class="weui-flex mile" style="display: block;overflow: hidden;">
	                            ...
	                            <div class="weui-flex__item right" style="width:60px;float:right;color:#999;">月售:${pd.num }</div>
	                        </div>
