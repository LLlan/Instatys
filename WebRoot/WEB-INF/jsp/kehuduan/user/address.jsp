...
<div id="header" style="background-color: #068dff;">
    ...
    <a href="api/h5KeHu/orderInfo.do?user_shangjia_id=${user_shangjia_id }" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<!--主体-->
<div class="container" >
        ...
        <div class="weui-panel__bd" style="padding:0;">
	       <c:forEach items="${pd}" var="pd">
	            <div class="weui-media-box ">
		                <a href="api/h5KeHu/addressEdit.do?shouhuo_address_id=${pd.shouhuo_address_id}&tag=1&user_shangjia_id=${user_shangjia_id }" class="address-edit"></a>
    ...
    <a href="api/h5KeHu/addressAdd.do?tag=1&user_shangjia_id=${user_shangjia_id }" class="address">
        <i></i>
        <span>新增地址</span>
    </a>
</div>
	...
	var user_shangjia_id = "${user_shangjia_id }";
		/* $(".delete").click(function(e){
                ...
                $(".sure").click(function(){
                    ...
                    del.parent().remove();
                    $(".noneBox").fadeOut();
				location.href="api/h5KeHu/addressDelete.do?shouhuo_address_id="+id+"&tag=1&user_shangjia_id="+user_shangjia_id;
                });
           /*  }); */
	} 
    $(function () {
