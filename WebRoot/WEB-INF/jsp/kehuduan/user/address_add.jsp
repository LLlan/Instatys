...
<div id="header" style="background-color: #068dff;">
	...
	<!--主体-->
<form id="Form" action="api/h5KeHu/${msg }.do?user_shangjia_id=${user_shangjia_id}&tag=${tag}" method="post" >
	<div class="container" >
	    <div class="weui-cells weui-cells_form wy-address-edit">
	        <div class="weui-cell">
	            <div class="weui-cell__hd"><label class="weui-label wy-lab">联系人:</label></div>
	            <input type="text" name="linkmanName" id="linkmanName" value="${pd.linkmanName}" maxlength="6" placeholder="联系人姓名(最多6个汉字)"/>
	        ...
	        <div class="weui-cell">
	            ...
	            <div class="weui-cell__bd"><input class="weui-input wab" name="address" id="addressa" value="${pd.address}" readonly="" data-code="420106" data-codes="420000,420100,420106"></div>
	        ...
	        <div class="weui-cell">
	            ...
	            <div class="weui-cell__bd">
		            ...
		            <input type="radio" class="form-con1" name="identity" checked="checked"  value="先生" <c:if test="${pd.identity=='先生' || pd.identity==''}">checked="checked"</c:if>/>先生
		            &nbsp;&nbsp;
	        ...
	        <div class="weui-cell">
	            ...
	            <div class="weui-cell__bd">
	                ...
	                <input type="radio" class="form-con1" name="lable" checked="checked"  value="家" <c:if test="${pd.lable=='家' || pd.lable==''}">checked="checked"</c:if>/>家 
		            &nbsp;&nbsp;
	        ...
	        <div class="weui-cell weui-cell_switch">
	            <div class="weui-cell__hd">设为默认地址：</div>&nbsp;&nbsp;
		            ...
		            &nbsp;&nbsp;
		            <input type="radio" class="form-con2" name="isDefault" checked="checked" value="1" <c:if test="${pd.isDefault=='1' }">checked="checked"</c:if>/>是&nbsp;&nbsp;
	    ...
	    <div class="weui-btn-area">
	        <a class="weui-btn weui-btn_primary" href="javascript:void(0)" onclick="add();" id="showTooltips">确定添加</a>
	    </div>
	</div>
...
<script>
	...
	function add(){
		...
		var addressa=$("#addressa").val();//所在地址
