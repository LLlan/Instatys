 	...
 	geolocation.getCurrentPosition(function(status, result) {
 		if (status == 'complete') {
			...
			//输出刚开始的经纬度
 			...
 			document.getElementById('inp1').setAttribute("value",result.position.O);
			document.getElementById('inp2').setAttribute("value",result.position.M);
 ...
 content.innerHTML = "<img src='static/images/wmpc/starts.png'>";
 ...
 var onMapMoveEnd = function() {
	 ...
	 /*console.log(position.O);//显示经纬度
	 console.log(position.M);//显示经纬度*/	
/*
 	document.getElementById('inp1').setAttribute("value",position.O);
	 document.getElementById('inp2').setAttribute("value",position.M);
	 console.log(document.getElementById('inp1'));
	 console.log(document.getElementById('inp2'));*/
