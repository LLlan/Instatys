...
var onInputClick = function(initText, onSelectCallback) {
	...
	placeSearch.listElementClickHandler = AMap.event.addListener(placeSearch, 'listElementClick', function(e) {
		...
		//输出经纬度
		/*console.log(e.data);
		console.log(e.data.location.O);
		console.log(e.data.location.M);*/
		/*document.getElementById('inp3').setAttribute("value",e.data.location.O);
		document.getElementById('inp4').setAttribute("value",e.data.location.M);
		console.log(document.getElementById('inp3'));
		console.log(document.getElementById('inp4'));*/
	})
...
var onOriginSelected = function(poi) {
	...
	if (destination.position) {
		...
		document.getElementById('inp1').setAttribute("value",origin.position.O);
		document.getElementById('inp2').setAttribute("value",origin.position.M);
		document.getElementById('inp3').setAttribute("value",destination.position.O);
		document.getElementById('inp4').setAttribute("value",destination.position.M);
